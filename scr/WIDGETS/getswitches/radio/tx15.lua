return {
  ...
  sw = {
    ...
    -----------------------------------------------------------------------------------------------------
    -- switch SW1
    { switchcfgname = "SW1", switchcfgpos_x = 25, switchcfgpos_y = 230, u = CHAR_UP, d = CHAR_DOWN },
    -- switch SW2
    { switchcfgname = "SW2", switchcfgpos_x = 100, switchcfgpos_y = 230, u = CHAR_UP, d = CHAR_DOWN },
    -- switch SW3
    { switchcfgname = "SW3", switchcfgpos_x = 175, switchcfgpos_y = 230, u = CHAR_UP, d = CHAR_DOWN },
    -- switch SW4
    { switchcfgname = "SW4", switchcfgpos_x = 255, switchcfgpos_y = 230, u = CHAR_UP, d = CHAR_DOWN },
    -- switch SW5
    { switchcfgname = "SW5", switchcfgpos_x = 330, switchcfgpos_y = 230, u = CHAR_UP, d = CHAR_DOWN },
    -- switch SW6
    { switchcfgname = "SW6", switchcfgpos_x = 405, switchcfgpos_y = 230, u = CHAR_UP, d = CHAR_DOWN },
